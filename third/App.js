...
const HeaderComponent = () => {   //functional component returns jsx
    return (
    // <div className='header'>  
    //         <img src= {logo} alt='logo'/>
    //         <input placeholder='Search Here' className='search' autoFocus='true' />
    // </div>
...
root.render(<HeaderComponent />) //to render the functional component we use angular brackets  
